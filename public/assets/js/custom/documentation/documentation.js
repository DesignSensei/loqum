...
var KTLayoutDocumentation = (function () {
  ...
  var keeniconsStyleToggle = function () {
    var toggleButtons = [].slice.call(
      document.querySelectorAll('[data-kt-keenicons-style-toggle="true"]'),
    );
      ...
      function (e) {
        ...
        if (style === "duotone") {
          ...
          selectedIconCode = escapeHtml(
            '<i class="ki-duotone ki-' + selectedIconName + '">',
          );
          ...
          selectedIconCode = escapeHtml(
            '<i class="ki-' + style + " ki-" + selectedIconName + '"></i>',
          );
        }
    ...
    myModalEl.addEventListener("show.bs.modal", (event) => {
      document.querySelector("#kt_keenicons_use_title").innerHTML =
        selectedIconName;
      document.querySelector("#kt_keenicons_use_code").innerHTML =
        selectedIconCode;
    });
